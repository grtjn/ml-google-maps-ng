...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('/quickstart.html',
    ...
    '\n' +
    'SearchCtrl.$inject = [..., \'$window\', \'$state\', \'MLQueryBuilder\'];\n' +
    '\n' +
    'function SearchCtrl(..., $window, $state, qb) {\n' +
    '  ...\n' +
    '\n' +
    '  var initMapOptions = {\n' +
    ...
    '          qb.ext.geospatialConstraint(\'Locations\', ctrl.bounds)\n' +
    '        )\n' +
    '      );\n' +
    '\n' +
    '      ctrl.search();\n' +
